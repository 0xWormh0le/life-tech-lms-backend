...
import { paths } from '../../../../../adapter/_gen/clever-api-schema'
import { CLEVER_API_BASE_URL } from './constants'
...
axios.interceptors.request.use((request) => {
  // console.log('Starting Clever Request: ', request.url)
  return request
})
axios.interceptors.response.use(
  (response) => {
    // console.log('Clever Response: ', response.status, response.data)
    return response
  },
  (error) => {
    // console.log(
    //   'Clever Request Error: ',
...
export async function cleverApiRequest<
  Path extends UrlPaths,
  Method extends HttpMethods,
>(
