...
import { CleverDeleteStudentUseCase, IAdministratorRepository, IStudentRepository, ITeacherRepository } from './CleverDeleteStudentUseCase'
...
describe('test CleverDeleteStudentUseCase', () => {
  test('test CleverDeleteStudentUseCase - success', async () => {
    const studentRepository: IStudentRepository = {
      deactivateStudent: jest.fn(async function (studentId: string): Promise<Errorable<void, E<'UnknownRuntimeError'>>> {
        return {
          hasError: false,
          error: null,
          value: undefined,
    ...
    const usecase = new CleverDeleteStudentUseCase(studentRepository, districtAdministratorRepositroy, teacherRepository)
    ...
    const deleteStudentSpy = studentRepository.deactivateStudent as jest.Mock
  ...
  test('when student repository deactivateStudent method returns student not found error', async () => {
    const studentRepository: IStudentRepository = {
      deactivateStudent: jest.fn(async function (studentId: string): Promise<Errorable<void, E<'StudentNotFoundError'>>> {
        return {
          hasError: true,
          error: {
            type: 'StudentNotFoundError',
  ...
  test('when student repository deactivateStudent method returns run time error', async () => {
    const studentRepository: IStudentRepository = {
      deactivateStudent: jest.fn(async function (studentId: string): Promise<Errorable<void, E<'UnknownRuntimeError'>>> {
        return {
          hasError: true,
