import {
  RemoveStudentFromStudentGroupUseCase,
  IStudentGroupRepository,
  IStudentRepository,
  IAdministratorRepository,
  ITeacherRepository,
} from './RemoveStudentFromStudentGroupUseCase'
...
describe('test RemoveStudentFromStudentGroupUseCase', () => {
  test('test RemoveStudentFromStudentGroupUseCase - success', async () => {
    const studentRepository: IStudentRepository = {
      removeStudentFromStudentGroup: jest.fn(async function (studentGroupId: string, studentId: string): Promise<Errorable<void, E<'UnknownRuntimeError'>>> {
        return {
          hasError: false,
          error: null,
          value: undefined,
    ...
    const usecase = new RemoveStudentFromStudentGroupUseCase(studentRepository, studentGroupRepository, districtAdministratorRepositroy, teacherRepository)
    ...
    const removeStudentFromstudentGroupSpy = studentRepository.removeStudentFromStudentGroup as jest.Mock

    expect(removeStudentFromstudentGroupSpy.mock.calls).toEqual([[VALID_STUDENT_GROUP_ID, VALID_STUDENT_ID]])
  ...
  test('when student repository removeStudentFromstudentGroup method returns StudentNotFoundError', async () => {
    const studentRepository: IStudentRepository = {
      removeStudentFromStudentGroup: jest.fn(async function (studentGroupId: string, studentId: string): Promise<Errorable<void, E<'StudentNotFoundError'>>> {
        return {
          hasError: true,
          error: {
  ...
  test('when student repository removeStudentFromstudentGroup method returns run time error', async () => {
    const studentRepository: IStudentRepository = {
      removeStudentFromStudentGroup: jest.fn(async function (studentGroupId: string, studentId: string): Promise<Errorable<void, E<'UnknownRuntimeError'>>> {
        return {
          hasError: true,
  ...
  test('when student repository removeStudentFromstudentGroup method returns Permission denied', async () => {
    const studentRepository: IStudentRepository = {
      removeStudentFromStudentGroup: jest.fn(async function (studentGroupId: string, studentId: string): Promise<Errorable<void, E<'PermissionDenied'>>> {
        return {
          hasError: true,
          error: {
