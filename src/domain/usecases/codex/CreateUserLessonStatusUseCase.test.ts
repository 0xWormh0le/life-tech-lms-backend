...
import { CreateUserLessonStatusUseCase, ILessonRepository, IUserLessonStatusRepository } from './CreateUserLessonStatusUseCase'
...
describe('test CreateUserLessonStatusUseCase', () => {
  test('success create UserLessonStatus', async () => {
    ...
    const userLessonStatusRepository: IUserLessonStatusRepository = {
      createUserLessonStatus: jest.fn(async function (userLessonStatus: UserLessonStatus): Promise<Errorable<void, E<'UnknownRuntimeError'>>> {
        return {
          hasError: false,
          error: null,
          value: undefined,
    ...
    const usecase = new CreateUserLessonStatusUseCase(lessonRepository, userLessonStatusRepository)
    ...
    const createUserLessonStatusSpy = userLessonStatusRepository.createUserLessonStatus as jest.Mock
  ...
  test('There is no lesson related to given lesson id', async () => {
    ...
    const usecase = new CreateUserLessonStatusUseCase(lessonRepository, userLessonStatusesRepository)
    ...
    const createUserLessonStatusSpy = userLessonStatusesRepository.createUserLessonStatus as jest.Mock
