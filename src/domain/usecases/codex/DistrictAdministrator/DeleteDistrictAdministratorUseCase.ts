...
export class DeleteDistrictAdministratorsUseCase {
  constructor(
  ...
  > {
    ...
    const districtAdministratorErrorable =
      await this.districtAdministratorRepository.deleteDistrictAdministrators(
        administratorId,
      )
    ...
    if (districtAdministratorErrorable.hasError) {
      ...
      return {
        ...
        error: wrapError(
          ...
          `Failed to deleteDistrictAdministrators ${administratorId}`,
        ),
        value: null,
      }
    }
