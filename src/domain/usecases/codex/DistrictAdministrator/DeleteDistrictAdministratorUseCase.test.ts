import { DeleteDistrictAdministratorsUseCase, IDistrictAdministratorRepository } from './DeleteDistrictAdministratorUseCase'
import { E, Errorable } from '../../shared/Errors'

const VALID_ADMINISTRATOR_ID = 'b9484b02-2d71-4b3f-afb0-57057843a59d'
const INVALID_ADMINISTRATOR_ID = 'district-id-00001'

describe('Test DeleteDistrictAdministratorsUseCase', () => {
  test('Test DeleteDistrictAdministratorsUseCase - success', async () => {
    const districtAdministratorRepository: IDistrictAdministratorRepository = {
      deleteDistrictAdministrators: jest.fn(async function (): Promise<Errorable<{ message: string }, E<'UnknownRuntimeError' | 'AdministratorNotFound'>>> {
        return {
          hasError: false,
          error: null,
          value: {
    ...
    const usecase = new DeleteDistrictAdministratorsUseCase(districtAdministratorRepository)
    ...
    const deleteDistrictAdministratorsSpy = districtAdministratorRepository.deleteDistrictAdministrators as jest.Mock
