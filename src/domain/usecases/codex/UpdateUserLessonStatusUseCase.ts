...
export class UpdateUserLessonStatusUseCase {
  constructor(
  ...
  async run(
    ...
    const createOrUpdateUserLessonStatusResult =
      await this.userLessonStatuseRepository.updateUserLessonStatus({
        ...userLessonStatusInfo,
      })

    if (createOrUpdateUserLessonStatusResult.hasError) {
      return {
        hasError: true,
        error: wrapError(
          createOrUpdateUserLessonStatusResult.error,
